...
def add_adult(page):
    ...
    page.get_by_role("textbox", name="Bitte präzisieren").first.click()
    page.get_by_role("textbox", name="Bitte präzisieren").first.fill("Ivo")
    page.get_by_role("textbox", name="Bitte präzisieren").nth(1).click()
    ...
    page.get_by_role("textbox", name="Bitte präzisieren").nth(2).click()
    page.locator("div:nth-child(7) > .mt-16 > div > .mdt-select > .select-wrapper > .search > .mdt-input > .input-wrapper > .text-cut").click()
    ...
    page.locator("div:nth-child(9) > .mt-16 > .mdt-input > .input-wrapper > .text-cut").click()
    page.locator("div:nth-child(9) > .mt-16 > .mdt-input > .input-wrapper > .text-cut").fill("Bla")
    page.locator("div:nth-child(12) > .mt-16 > div > .mdt-select > .select-wrapper > .search > .mdt-input > .input-wrapper > .text-cut").click()
    page.get_by_text("Solidarhafter", exact=True).click()
    page.get_by_role("textbox", name="123 45 67").first.click()
    page.get_by_role("textbox", name="123 45 67").first.fill("333333333")
    page.get_by_role("textbox", name="123 45 67").nth(1).click()

    page.locator("input[type=\"email\"]").first.click()
    page.locator("input[type=\"email\"]").first.fill(email)
    page.locator("input[type=\"email\"]").nth(1).click()
    page.locator("input[type=\"email\"]").nth(1).fill(email)

    page.locator("div:nth-child(13) > .mt-16 > .mdt-input > .input-wrapper > .text-cut").click()
    page.locator("div:nth-child(13) > .mt-16 > .mdt-input > .input-wrapper > .text-cut").fill("efs")
    page.get_by_role("spinbutton").first.click()
    page.get_by_role("spinbutton").first.fill("3")
    page.locator("div:nth-child(15) > .mt-16 > .mdt-input > .input-wrapper > .text-cut").click()
    page.locator("div:nth-child(15) > .mt-16 > .mdt-input > .input-wrapper > .text-cut").fill("gwawag")
